...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='../configs/cityscapes/faster_rcnn_tsne.py')
    # parser.add_argument(
...
def main():
    ...
    checkpoint1 = load_checkpoint(model, args.checkpoint, map_location='cpu')

    if 'CLASSES' in checkpoint1.get('meta', {}):
        model.CLASSES = checkpoint1['meta']['CLASSES']
    else:
        model.CLASSES = dataset.CLASSES

    tSNE_result_1 = tSNE_test(model, data_loader)
